...
router.get('/blogs/trashed', [BlogsController, 'trashed'])
  .use(middleware.auth())
...
router
  .group(() => {
    ...
    router.get('/employees/trashed', [EmployeesController, 'trashed'])
      .use(middleware.role(['admin']))
    router.get('/employees', [EmployeesController, 'index'])
    router.post('/employees', [EmployeesController, 'store'])
      .use(middleware.role(['admin']))
    router.put('/employees/:id/restore', [EmployeesController, 'restore'])
      .use(middleware.role(['admin']))
    ...
    router.put('/users/:id/role', [UsersController, 'updateRole'])
      .use(middleware.role(['admin']))
    router.put('/users/:id/toggle-active', [UsersController, 'toggleActive'])
      .use(middleware.role(['admin']))
    router.put('/users/:id', [UsersController, 'update'])
      .use(middleware.role(['admin']))

    router.get('/gallery/trashed', [GalleryController, 'trashed'])
      .use(middleware.role(['admin']))
    router.get('/gallery', [GalleryController, 'index'])
    router.post('/gallery', [GalleryController, 'store'])
    router.put('/gallery/:id/restore', [GalleryController, 'restore'])
      .use(middleware.role(['admin']))
    ...
    router.put('/blogs/:id/restore', [BlogsController, 'restore'])
      .use(middleware.role(['admin']))
